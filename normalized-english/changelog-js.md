...
```
  ...
  * `GraphNode
` - Type node functions with full inference
  * `ConditionalEdgeRouter
` - Type conditional edge routers
...
[查看相关页面](/oss/javascript/langgraph/graph-api#schema)
...
[查看相关页面](/oss/javascript/langgraph/graph-api#type-utilities)
